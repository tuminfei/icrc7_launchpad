...
import { idlFactory } from './archive.did.js';
export { idlFactory } from './archive.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ARCHIVE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./archive.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the archive canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./archive.did.js")._SERVICE>}
 */
export const archive = createActor(canisterId);
